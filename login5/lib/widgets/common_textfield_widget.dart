  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      style: GoogleFonts.cinzel(
        ...
        textStyle: textTheme.bodyLarge?.copyWith(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),
      ),
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: widget.isPasswordField
          ...
          child: Icon(Icons.visibility, color:  Theme.of(context).primaryColor),
        )
            : GestureDetector(
          onTap: () {
            setState(() {
          ...
          child: Icon(Icons.visibility_off, color: AppColors.hintTextColor),
        )
            : SizedBox(),
      ),
    );
